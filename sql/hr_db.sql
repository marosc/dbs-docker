...
-- Čas generovania: St 23.Apr 2025, 10:02
...
--
-- Štruktúra tabuľky pre tabuľku `regions`
--
...
--
-- Sťahujem dáta pre tabuľku `regions`
--
...
--
-- Indexy pre tabuľku `departments`
--
...
--
-- AUTO_INCREMENT pre tabuľku `departments`
--
ALTER TABLE `departments`
...
--
-- AUTO_INCREMENT pre tabuľku `locations`
--
ALTER TABLE `locations`
  MODIFY `location_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3201;

--
-- AUTO_INCREMENT pre tabuľku `regions`
--
ALTER TABLE `regions`
